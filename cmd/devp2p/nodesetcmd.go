...
func ethFilter(args []string) (nodeFilter, error) {
	...
	case "mainnet":
		...
		filter = forkid.NewStaticFilter(params.EnulsChainConfig, params.EnulsGenesisHash)
	case "rinkeby":
		filter = forkid.NewStaticFilter(params.RinkebyChainConfig, params.RinkebyGenesisHash)
	case "enuls":
		filter = forkid.NewStaticFilter(params.EnulsChainConfig, params.EnulsGenesisHash)
	case "enulstest":
		filter = forkid.NewStaticFilter(params.EnulsTestChainConfig, params.EnulsTestGenesisHash)
	case "goerli":

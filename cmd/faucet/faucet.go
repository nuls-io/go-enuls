...
var (
	...
	enulsFlag     = flag.Bool("enuls", false, "Initializes the faucet with Enuls network config")
	enulsTestFlag = flag.Bool("enulstest", false, "Initializes the faucet with Enuls-Testnet network config")
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *goerliFlag, *rinkebyFlag, *sepoliaFlag, *enulsFlag, *enulsTestFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, goerliFlag bool, rinkebyFlag bool, sepoliaFlag bool, enulsFlag bool, enulsTestFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
	...
	case enulsFlag:
		return core.DefaultEnulsGenesisBlock(), nil
	case enulsTestFlag:
		return core.DefaultEnulsTestGenesisBlock(), nil
	case sepoliaFlag:

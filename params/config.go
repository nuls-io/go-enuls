...
var (
	...
	// 设置了enuls网络的创世块hash
	EnulsGenesisHash     = common.HexToHash("0xc169c82065e3b78551f10fa1da6ac98d52d81e2ae19f18a65d9e8bd75c473918")
	EnulsTestGenesisHash = common.HexToHash("0xe44ffaba349b655017ac314220305c822235c21e8e48b07a783a592e1d7aa9fd")
...
var TrustedCheckpoints = map[common.Hash]*TrustedCheckpoint{
	...
	//EnulsGenesisHash:        EnulsTrustedCheckpoint,
	//EnulsTestGenesisHash: EnulsTestTrustedCheckpoint,
...
var CheckpointOracles = map[common.Hash]*CheckpointOracleConfig{
	...
	//EnulsGenesisHash:        EnulsCheckpointOracle,
	//EnulsTestGenesisHash: EnulsTestCheckpointOracle,
...
var (
	...
	EnulsTestChainConfig = &ChainConfig{
		ChainID:             big.NewInt(120),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
	...
	EnulsChainConfig = &ChainConfig{
		ChainID:             big.NewInt(119),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
...
var NetworkNames = map[string]string{
	...
	EnulsChainConfig.ChainID.String():     "enuls",
	EnulsTestChainConfig.ChainID.String(): "enulstest",
